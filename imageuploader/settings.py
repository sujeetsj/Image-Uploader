...
SECRET_KEY = 'django-insecure-!2^l1xa503%#h0aauqfpofh1h_*v5vnv7l#y(krtbasjn1pq__'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Add this line to register the project-level templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
